...
const Header = () => {
    ...
    const {cityId, SetCityId} = useContext(WeatherContext);
    ...
    return (
        <div className="header">
            <select name="city" id="citySelector" onChange = {(e) => getCityName(e)}>
            ...
            <div className="region">
              <p>Region: <span>{cityData[cityId-1].region}</span></p>
            </div>
